...
>([
  ...
  [
    'screen_activeVideo_alignment_status_not_centered',
    {
      ...
      properties: { event_type: 'view', alignment_status: 'face not centered' },
    },
  ],
  [
    ...
    {
      eventName: 'FACE_LIVENESS_ALIGNMENT_STATUS',
      properties: { event_type: 'view', alignment_status: 'face too close' },
    },
  ],
  [
    ...
    {
      eventName: 'FACE_LIVENESS_ALIGNMENT_STATUS',
      properties: { event_type: 'view', alignment_status: 'face too far' },
    },
  ],
  [
    ...
    {
      eventName: 'FACE_LIVENESS_ALIGNMENT_STATUS',
      properties: { event_type: 'view', alignment_status: 'face aligned' },
    },
  ],
  [
